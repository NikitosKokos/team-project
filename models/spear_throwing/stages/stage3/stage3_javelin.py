...
# Constants
MODEL_PTH_PATH = "/Users/danyukezz/Desktop/2 year 1 semester/team project/preprocessing_sports/spear_throwing/stages/stage3/models/stage3_javelin.pth"
VIDEO_DIR = "/Users/danyukezz/Desktop/2 year 1 semester/team project/preprocessing_sports/spear_throwing/stages/stage3/test_videos"
SEQUENCE_LENGTH = 20
INPUT_SIZE = 513
...
def process_and_predict(video_path, model, sequence_length):
    ...
    prediction = 0 if prediction < 0.4 else 0.5 if prediction < 0.8 else 1
