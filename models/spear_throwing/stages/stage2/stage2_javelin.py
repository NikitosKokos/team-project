...
# Constants
MODEL_PTH_PATH = "/Users/danyukezz/Desktop/2 year 1 semester/team project/preprocessing_sports/spear_throwing/stages/stage2/models/stage2_javelin.pth"
VIDEO_DIR = "/Users/danyukezz/Desktop/2 year 1 semester/team project/preprocessing_sports/spear_throwing/stages/stage2/test_videos"
SEQUENCE_LENGTH = 20
INPUT_SIZE = 514
...
class TemporalModel(nn.Module):
    def __init__(self, input_size=514, hidden_size=128, num_layers=1, output_size=1):
...
def process_and_predict(video_path, model, sequence_length):
    ...
    prediction = 0 if prediction < 0.5 else 0.5 if prediction < 0.8 else 1
